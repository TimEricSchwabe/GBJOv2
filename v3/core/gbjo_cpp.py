...
Build (macOS):
    clang++ -O3 -std=c++17 -dynamiclib -framework Accelerate \
        -DACCELERATE_NEW_LAPACK -o v3/artifacts/lib/libgbjo.dylib v3/pack/gbjo_kernel.cpp
Build (Linux):
    g++ -O3 -std=c++17 -shared -fPIC -o v3/artifacts/lib/libgbjo.so \
        v3/pack/gbjo_kernel.cpp -lopenblas
"""
...
from v3.core.gbjo_fast import FastGBJO, FlatCostGNN, beam_exact
from v3 import paths

_EXT = "dylib" if sys.platform == "darwin" else "so"
_LIB = str(paths.LIB / f"libgbjo.{_EXT}")
