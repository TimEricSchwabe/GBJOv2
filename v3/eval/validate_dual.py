...
For each held-out eval path query (the same 100 used by featurize):
...
Usage:
    uv run python -m v3.eval.validate_dual --model v3/artifacts/models/dual-v1/model.pt \
...
from v3.core.featurize import build_query_set, order_to_adjacency, MODEL
from v3.core.dual_data import triple_var_sets, share_edge_index
from v3.core.model_dual import CostGNNDual
from v3.core.gbjo_fast import FlatCostGNN
from v3.datagen.gen_cartesian_plans import (var_sets, connected_order, corrupted_order,
                                 count_cart, CostOracle)


def main():
    ap = argparse.ArgumentParser()
    ap.add_argument("--model", default="v3/artifacts/models/dual-v1/model.pt")
