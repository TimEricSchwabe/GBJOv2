...
vs v3.core.gbjo_fast::FastGBJO (eager and torch.compile) on identical
featurized wikidata-star queries.

Usage:
    uv run python -m v3.eval.bench_compare [--steps 10] [--per-size 3] [--sizes 4 6 8 10 12 14]
"""
...
from v3.core.gbjo_fast import FastGBJO, FlatCostGNN, featurize_query, adjacency_to_join_order
...
CACHE = str(paths.CACHE / "bench_cache.pt")
