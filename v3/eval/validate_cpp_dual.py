...
Usage:
    uv run python -m v3.eval.validate_cpp_dual \
        --model v3/artifacts/models/dual-v2/model_rank.pt
    uv run python -m v3.eval.validate_cpp_dual \
        --model v3/artifacts/models/lubm-dual-v1/model_rank.pt \
        --queries data/queries/lubm/paths/path_queries.json \
        --emb-dir data/embeddings/lubm \
        --cache v3/artifacts/cache/bench_cart_cache_lubm.pt --sizes 3 4 5
"""
...
from v3.core.featurize import PATH_PARAMS, build_query_set
from v3.core import featurize as bc
from v3.core.gbjo_fast import FastGBJO
...
def main():
    ...
    ap.add_argument("--model", default="v3/artifacts/models/dual-v2/model_rank.pt")
