...
Current-state run (no ranking, as in dual-v1):
    uv run python -m v3.train.train_dual --epochs 60 --out .../dual-v1b
FICE-style run:
    uv run python -m v3.train.train_dual --epochs 200 --cart-weight 10 \
...
def main():
    ...
    ap.add_argument("--out", default="v3/artifacts/models/dual-v2")
