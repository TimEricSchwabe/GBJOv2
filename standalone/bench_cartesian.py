...
Usage:
    uv run python standalone/bench_cartesian.py [--steps 10] [--per-size 25]
...
from gbjo_fast import (FastGBJO, FlatCostGNN, featurize_query, sharing_matrix,
...
CACHE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bench_cart_cache.pt")
