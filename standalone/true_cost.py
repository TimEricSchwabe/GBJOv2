...
Usage:
    uv run python standalone/true_cost.py --sizes 5 8 --per-size 2 \
...
from gbjo_fast import (FastGBJO, FlatCostGNN, adjacency_to_join_order,
                       count_cartesian_joins)
from bench_cartesian import PATH_PARAMS, MODEL, build_query_set
...
def main():
    ...
    for qi, it in enumerate(items):
        ...
        if conn is not None:
            from bench_cartesian import order_to_adjacency as o2a
