...
def plot_statistics(stats):
    ...
    plt.title('Distribution of Plans Found by Optimizer')
    plt.ylim(0, 100)
    ...
    labels = ['Optimizer', 'Best', 'Random', 'Middle', 'Worst']
    means = [mean_optimizer, mean_best, mean_random, mean_middle, mean_worst]
    
    plt.bar(labels, means, color=['blue', 'green', 'purple', 'orange', 'red'])
    ...
    print(f"Mean ratio of optimizer cost to best cost: {optimizer_to_best_ratio:.2f}x")
    
    # Calculate and print how often the optimizer beats random selection
    ...
    print(f"Optimizer beats random selection in {optimizer_win_pct:.1f}% of queries")


if __name__ == "__main__":
    # Set paths
    queries_dir = "sparql_queries_3"
    model_path = "/home/tim/query_optimization/explicit_join_model/models/GIN_3_tp_v1.pt"
    num_queries = 1
