"""
Data utilities for plan manipulation, validation and data processing.

Contains functions for converting between plan formats, validating plans,
loading data, and other data-related operations.
"""
